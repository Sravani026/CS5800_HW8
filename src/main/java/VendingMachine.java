...
public class VendingMachine {
    ...
    public void printAllSnacks() {
        StringBuilder allSnackOptions = new StringBuilder("List of Snacks Available: [");
        for (int i = 0; i < snacks.size(); i++) {
            allSnackOptions.append(snacks.get(i).getName());
            if (i < snacks.size() - 1) {
                allSnackOptions.append(", ");
            }
        }
        allSnackOptions.append("]");
        System.out.println(allSnackOptions.toString());
    }

    public void printSnackDetails() {
        String allSnackOptions = "Snack Details: ";
